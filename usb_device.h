...
/** EXTERNS ********************************************************/
	...
	extern ROM BYTE configDescriptor1[];
		...
		extern ROM BYTE *ROM USB_CD_Ptr2[];
	#else
	...
	//Class specific - HID report descriptor
		...
		extern ROM struct{BYTE report[HID_RPTK_SIZE];} hid_rptk;
		extern ROM struct{BYTE report[HID_RPTM_SIZE];} hid_rptm;
	#endif
	#endif
