...
#ifndef HARDWARE_PROFILE_APKB
#define HARDWARE_PROFILE_APKB
	...
	#define	SIDE_SW_KEYBOARD	1
	#define	SIDE_SW_MOUSE	0
	#define APKB_HW_VER 4
	#define	SIDE_SW_ON	0
	#define	SIDE_SW_OFF	1

#endif  //HARDWARE_PROFILE_APKB
