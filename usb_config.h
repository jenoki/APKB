...
#define USB_MAX_EP_NUMBER	3	//#define USB_MAX_EP_NUMBER	2

/* HID */
#define HID_INTF_IDK			0x01
#define HID_INTF_IDM			0x00
#define HID_EPK 			1
#define HID_EPM 			2
#define HID_INT_OUT_EP_SIZE		3
#define HID_INT_IN_EP_SIZE		8
#define HID_INT_IN_EPM_SIZE		3
#define HID_NUM_OF_DSC			1
#define HID_RPTK_SIZE			63
#define HID_RPTM_SIZE			67
